...
### 🚀 ساخت خودکار همه چی برای یه فیچر
...
برای ارسال و دریافت نوتیفیکیشن‌ها از Firebase می‌تونی با این قالب خیلی ساده کار کنی. حتی اگه تجربه زیادی نداری، اینجا کارها برات راحت‌تر شده.
